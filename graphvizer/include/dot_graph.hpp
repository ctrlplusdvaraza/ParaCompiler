...
class DotGraph
{
  ...
  public:
    ...
    {
        std::string temp_dot_file = "temp.dot";

        {
            std::ofstream dot_file(temp_dot_file, std::ios::binary);
            if (!dot_file)
            {
